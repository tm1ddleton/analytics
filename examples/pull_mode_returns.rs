...
use analytics::{
    ReturnsQueryBuilder, AssetKey, DateRange, InMemoryDataProvider, TimeSeriesPoint,
};
...
fn main() {
    ...
    let (dag, data_node_id, returns_node_id) = builder.build_dag()
